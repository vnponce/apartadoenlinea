...
/* harmony import */ var _components_ProductListElement__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/ProductListElement */ "./resources/js/components/ProductListElement.jsx");
/* harmony import */ var _babel_runtime_helpers_esm_set__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @babel/runtime/helpers/esm/set */ "./node_modules/@babel/runtime/helpers/esm/set.js");
...
function Order() {
  ...
  console.log('content =>', content); // const { stores } = props;
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
      ...
      currentStore = _useState4[0],
      setCurrentStore = _useState4[1];
  ...
  var _useState9 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null),
      ...
      hour = _useState10[0],
      setHour = _useState10[1];

  var _useState11 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(''),
      _useState12 = _slicedToArray(_useState11, 2),
      employeeName = _useState12[0],
      setEmployeeName = _useState12[1]; // customer info
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    if (content && Object.values(content).length > 0) {
      var existedOrder = Object.keys(content).find(function (product) {
        return content[product].id === 'orderDetailsId';
      });
      console.log(content[existedOrder]);
      var currentStoreId = content[existedOrder].options.store;
      var currentStoreObject = stores.find(function (store) {
