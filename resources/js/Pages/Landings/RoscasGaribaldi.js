            ...
            <MainWrapper className="h-full bg-brand-orange w-full flex items-center flex-col px-8">
                <div className="pt-20 text-4xl text-center md:text-6xl">
                    <div className="text-center">
                        <span className="text-orange-200">¡Roscas de</span>
                    </div>
                    <div className="text-orange-200 -mt-4 md:-mt-8">Garibaldi Rellenas!</div>
                </div>
                {/* precios */}
                ...
                <div className="text-white mt-8 font-bold italic text-lg  md:text-3xl">
                    Llama al 2299318285 y haz tu pedido a tu sucursal más cercana
                </div>
                {/* sucursal */}
...
export default RoscasGaribaldi;
