            ...
            <div className="mt-4 w-full pb-24 ">
                ...
                <div className="px-4 lg:w-1/2 lg:float-left lg:content-end">
                    ...
                    <div className="lg:w-3/4 lg:float-right">
                        ...
                        {/* Ver mapa */}
                        <button className="flex cursor-pointer justify-center font-bold py-2 px-4 rounded w-1/2 m-auto mt-4 block bg-transparent border border-brand-orange text-brand-orange text-bold hover:bg-brand-orange hover:text-white hover:shadow hover:text-white sm:hidden">
                            <span>Ver el mapa</span>
                            <svg version="1.1" className="stroke-current fill-current w-6" id="Location_pin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" >
                ...
                <div className="px-4 lg:w-1/2 lg:float-left">
                    ...
                    {/* 'Proceder' Next step */}
                    <InertiaLink href="/charola" className="flex cursor-pointer justify-center font-bold py-2 px-4 rounded w-1/2 m-auto mt-4 block bg-transparent border border-brand-orange text-brand-orange text-bold hover:bg-brand-orange hover:text-white hover:shadow hover:text-white">
                        <span>Proceder</span>
                    </InertiaLink>
                </div>
            </div>
