...
export default function CreateProduct(props) {
  const {
    data, setCreateProduct, editing = false, setEditing = () => {}, setDataSelected,
  } = props;
  const {
    errors, stores, categories, flash,
  } = usePage();
  ...
  useEffect(() => {
      if (window.Cypress) {
          const dataBase64 = '/9j/4AAQSkZJRgABAQEAZABkAAD/7AARRHVja3kAAQAEAAAAZAAA/9sAQwACAQEBAQECAQEBAgIC\n'
  ...
  const getFormData = () => {
    ...
    formData.set('customizable', productData.customizable);
