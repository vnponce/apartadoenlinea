        ...
        <>
            <div className="font-light text-sm text-gray-600 mt-4 sm:text-center lg:text-justify">
                ...
                <input id={id}
                       ...
                       onChange={onChange}
                       style={{ height: '2.4rem' }}
                       className="border border-transparent rounded w-full mt-1 bg-white border-gray-400 hover:border-orange-400 hover:shadow-xl focus:border-orange-400 focus:outline-none px-3 py-1 sm:m-auto lg:w-full disabled:bg-brand-grayOpt disabled:cursor-not-allowed"
